    ...
    <div className="h-full bg-gray-600 flex items-center justify-center">
      <div className="relative max-w-4xl w-full h-[60vh] shadow-lg rounded-lg overflow-hidden">
        ...
        <video
          ...
          src="/dribble.mp4" // Unique video for Dribble
          autoPlay
          loop
          muted
        ></video>
        ...
        <div className="relative z-10 bg-black bg-opacity-50 h-full p-8">
          <h1 className="text-3xl font-bold text-white mb-4">Dribble</h1>
          <p className="text-gray-300 mb-6">
            A creative space for showcasing innovative designs.
          </p>
          ...
          <a
            href="https://dribble.example.com"
            target="_blank"
